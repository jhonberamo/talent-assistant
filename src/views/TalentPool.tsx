...
import { Search, Loader2, User, Building, ExternalLink, Award, XCircle, CheckCircle2, Sparkles, Database } from 'lucide-react';
...
export function TalentPool() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!import.meta.env.VITE_SEARCH_TALENT_POOL_API_URL) {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_SEARCH_TALENT_POOL_API_URL, {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-start gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-3xl">
                Search through your curated talent pool of pre-screened candidates. These candidates have already shown interest in your organization and have been vetted for quality and potential fit. Find the perfect match from your existing talent database.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-150 ease-in-out disabled:opacity-50"
            >
              {isLoading ? (
                <>
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
                ...
                <div className="border-t border-gray-100 p-4 bg-gray-50 rounded-b-xl mt-auto">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 text-purple-500 hover:text-purple-600 font-medium"
                  >
        ...
        {!isLoading && !error && candidates.length === 0 && jobTitle && (
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            <p className="text-gray-600">No candidates found in the talent pool. Try adjusting your search criteria.</p>
          </div>
        )}
